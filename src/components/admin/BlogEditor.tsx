...
export default function BlogEditor({ content, onChange }: BlogEditorProps) {
  ...
  return (
    <div className="border rounded-lg overflow-hidden bg-background flex flex-col">
      ...
      <EditorContent editor={editor} className="tiptap-editor prose prose-sm sm:prose max-w-none p-4 h-[500px] overflow-y-auto focus:outline-none [&_.ProseMirror]:outline-none [&_.ProseMirror]:min-h-full [&_.ProseMirror]:break-words [&_.ProseMirror]:[overflow-wrap:anywhere] [&_.ProseMirror]:whitespace-pre-wrap" />
    </div>
  );
}
